cordova.define("cordova-plugin-canvas-gamepad.CDVGamepad", function(require, exports, module) {
/*
	...
	*/
	var events = {
		bind:function()
		{
			...
			for(var e in ev)
			{
				canvas.addEventListener(ev[e], CDVGamepad.events, false);
			}			
		},
		listen:function(e)
		{

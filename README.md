...
This is a project about noise levels.  Specifically the recorded noise levels on the San Francisco subway system commonly referred to as [BART](https://en.wikipedia.org/wiki/Bay_Area_Rapid_Transit).  I wanted to find a way to express these sounds visually and to turn it into a real-time virtual BART experience.  I divided this project up into a fea categories:

 - dB level recordings  ([how loud is loud](https://en.wikipedia.org/wiki/Decibel))
 - Sound Map Design
 - Mobile Experience by [@seacloud9](http://twitter.com/@seacloud9) (forthcoming)
 - App Communication
 - Deployment
 - Wifi & Delivery
 - tl;dr DEPLOY
...
Using this data and a Python library called [Plot.ly](https://plot.ly/), I created a depth map which when [extruded in Maya](https://knowledge.autodesk.com/support/maya/learn-explore/caas/CloudHelp/cloudhelp/2016/ENU/Maya/files/GUID-9E4B4E8F-F4B7-4005-B3F0-5441E65170CF-htm.html) creates this very depressing aural mesh: ![This view is from the sounth.  The large hump in the middle is the route under the San Francisco bay](https://cdn-images-1.medium.com/max/2000/1*zFv2hk7tDMsYvXiGYkmWbw.png)
...
### Deployment
[Surge is great!](http://surge.sh/) && FREE!  To the Max!
 - `npm install -g surge`
 - `surge www` .... [deployed domain]
...
2. copy() the *URL.io* after setting up an endpoint.
3. Paste into two places
    * The [BART Control  endpoint](https://github.com/cubicleDowns/SF-Underground/blob/master/app/js/ks.js).
    * TODO: Brendon's Link
4. Somehow run `app` && `rider/www`.
